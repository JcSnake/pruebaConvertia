...
<body>
    ...
    <section id="contrato-home-mobile" class="bg-contrata row h-100 w-100 mx-auto d-mobile">
    ...
    <div class="bg-pleca">
        <div class="col-md-6 mx-auto d-flex justify-content-between align-items-center h-100">
            <div class="col-4">
                <button class="btn btn-blue text-uppercase col-12 p-2">triple pack</button>
            </div>
            <div class="col-4">
    ...
    <section id="paquetes" class="mb-5">
        <div class="col-md-10 mx-auto">
            <div>
                <div class="col-md-12 mx-auto row mt-5 shadow-paquetes p-4">
                    <div class="col-12 col-md-9">
                        ...
                        <span class="ms-3 fw-700 c-gray-dark">+80 Canales + 50 Canales HD</span>        
                        <div class="collapse" id="paquete5">
                            <div class="card card-body border-0">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="./assets/images/wifi.svg" alt="wifi"><span class="ms-3">Conexión a internet</span>
                                    </div>
            ...
            <div>
                <div class="col-md-12 mx-auto row mt-5 shadow-paquetes p-4">
                    <div class="col-12 col-md-9">
                        ...
                        <span class="ms-3 fw-700 c-gray-dark">+ 120 Canales + 90 Canales HD</span>        
            ...
            <div>
                <div class="col-md-12 mx-auto row mt-5 shadow-paquetes p-4">
                    <div class="col-12 col-md-2 d-flex align-items-center">
                        <p class="c-gray-dark fw-700 text-uppercase">xview total 200</p>
                    </div>
                    <div class="col-12 col-md-7">
                        <img src="./assets/images/200mbps.png" alt="200mbps">
                        <span class="ms-3 fw-700 c-gray-dark">+ 120 Canales + 90 Canales HD</span>        
            ...
            <div>
                <div class="col-md-12 mx-auto row mt-5 shadow-paquetes p-4">
                    <div class="col-12 col-md-2 d-flex align-items-center">
                        <p class="c-gray-dark fw-700 text-uppercase">xview total 350</p>
                    </div>
                    <div class="col-12 col-md-7">
            ...
            <div>
                <div class="col-md-12 mx-auto row mt-5 shadow-paquetes p-4">
                    <div class="col-12 col-md-2 d-flex align-items-center">
                        <p class="c-gray-dark fw-700 text-uppercase">xview total 500</p>
                    </div>
                    <div class="col-12 col-md-7">
            ...
            <div>
                <div class="col-md-12 mx-auto row mt-5 shadow-paquetes p-4">
                    <div class="col-12 col-md-2 d-flex align-items-center">
                        <p class="c-gray-dark fw-700 text-uppercase">xview total 1GB</p>
                    </div>
                    <div class="col-12 col-md-7">
